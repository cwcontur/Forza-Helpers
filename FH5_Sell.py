...
class App(ttk.Frame):
    ...
    def verifying(self):
        if window_exist:
            ...
            while True:
                self.auction_car_not_looking = pyautogui.locateOnScreen(Auc_Car_Not, confidence=.55, grayscale=True)
                self.auction_car_hovered_looking = pyautogui.locateOnScreen(Auc_Car_Hovered, confidence=.55, grayscale=True)
            ...
            self.start_time = time.time()
            while True:
                self.create_auction_looking = pyautogui.locateOnScreen(Create_Auction, confidence=.55, grayscale=True)
    ...
    def getting_ready(self):
        if window_exist:
            ...
            self.start_time = time.time()
            while True: 
                self.initial_price_hovered_looking = pyautogui.locateOnScreen(Initial_Price_Hovered, confidence=.55, grayscale=True)
                self.initial_price_not_looking = pyautogui.locateOnScreen(Initial_Price_Not, confidence=.55, grayscale=True)
            ...
            if self.not_at_min:
                ...
                self.start_time = time.time()
                while True:
                    self.buyout_price_hovered_looking = pyautogui.locateOnScreen(Buyout_Price_Hovered, confidence=.55, grayscale=True)
                    self.buyout_price_not_looking = pyautogui.locateOnScreen(Buyout_Price_Not, confidence=.55, grayscale=True)
                ...
                self.start_time = time.time()
                while True:
                    self.confirm_hovered_looking = pyautogui.locateOnScreen(Confirm_Hovered, confidence=.55, grayscale=True)
                    self.confirm_not_looking = pyautogui.locateOnScreen(Confirm_Not, confidence=.55, grayscale=True)
    ...
    def start_system(self):
        if window_exist:
            ...
            if self.ready_to_start and self.computers_connected and self.server_connection:
                ...
                self.update()
                while True:
                    self.starting_auction_looking = pyautogui.locateOnScreen(Starting_Auction, confidence=.55, grayscale=True)
                ...
                self.update()
                while True:
                    self.live_auction_looking = pyautogui.locateOnScreen(Live_Auction, confidence=.55, grayscale=True)
